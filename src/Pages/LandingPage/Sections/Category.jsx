          ...
          <div class=" trademark-box-wrap mb-[30px] flex-[0_0_50%] max-w-[50%] relative w-full px-[15px]">
            ...
            >
              ...
              <div className="text-content-trademark max-w-[555px] m-auto text-center text-white text-[15px] p-5 mb-[80px]">
                <p className="mb-[1rem]">
                  Chao Xian - concept lẩu bò tươi lấy cảm hứng từ vùng đất lẩu
                  ngon nức tiếng Triều Châu hứa hẹn mang đến cho thực khách
                  những trải nghiệm chất lượng nhất về thịt bò tươi hảo hạng
                  nhúng lẩu.
                  <br />
                  Với giống bò được tuyển chọn theo tiêu chí riêng của nhà hàng,
                  chăn nuôi theo phương pháp đặc biệt và hơn hết những phần thịt
                  bò ngon nhất sẽ được mang trực tiếp từ trang trại đến bàn ăn
                  không quá 4h đồng hồ giúp nâng tầm hương vị bò tươi mỗi ngày.
                </p>
              </div>
