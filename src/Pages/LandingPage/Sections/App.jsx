    ...
    <div className="App banner-trademark">
      <div className="container">
        <div className="flex flex-wrap mx-[-15px] pt-[200px]">
          <div class="text-content-banner-left">
            <div class="title-app-banner text-[20px] font-bold pt-[37px] pb-[33px]">
              ỨNG DỤNG THANH TOÁN &amp; TÍCH ĐIỂM PHANEXPRESS
            </div>
            <div class="text-content-app-banner text-[14px]">
              <div>
            ...
            <div class="img-app flex mt-[47px]">
              ...
              <div class="qr_os">
                <img
                  ...
                  alt=" "
                  class="max-w-full h-auto w-[80px]"
                />
              </div>
            </div>
          </div>
